...
def evaluation(distmat, query_labels, gallery_labels, max_rank=20, LOO = "query"):
    ...
    # Get rid of the match with the same person and image as considering LOOQ strategy (perfect match is first in always rank 1)
    remove = [False for _ in range(num_g)]
    if LOO == "query":
        remove[0] = True
